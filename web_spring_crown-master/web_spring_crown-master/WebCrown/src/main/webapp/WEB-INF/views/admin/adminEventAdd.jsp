...
function readImgURL(input){
   ...
   (ext == "gif" || ext == "png" || ext == "jpeg" || ext == "jpg")){
	...
	<div class="admin_content_wrap" id="admin_content_wrap">
		<form method="post" id="eventAddFrm" action="<%=ctx%>/adminEventAddOk" enctype="multipart/form-data">
		...
		<div class="admin_content_box admin_half_w ">
			<div class="admin_content_form">
				<div class="admin_input_frm">
					<div>이벤트 제목</div>
					<input type="text" name="event_name" id ="event_name" maxlength="50"/>
				</div>
				<hr/>
				<div class="admin_input_frm">
					<div>이벤트 내용</div>
					<br/>
					<textarea name="dsp" class="cont" id="event_mdsp" rows="10" cols="59"></textarea>
				</div>
				<hr/>
				<div class="pack_item_dsp">
					<div>상세 내용</div><br/>
					<textarea name="sdsp" class="cont" id="event_sdsp" rows="15" cols="59"></textarea>
				</div>
				<hr/>
				<div class="pack_date">
					<p>&nbsp;&nbsp;이벤트 기간</p>
					<input type="text" name="event_start" id="event_start" val="" maxlength="20"/> ~ <input type="text" name="event_end" id="event_end" value="" maxlength="20"/>
			...
			<div class="admin_content_form">
				...
				<div>
		   			<div class ="admin_img_box">
		    			<img id="eventMainImg" alt="메인 이미지" src="" onError="this.src='<%=ctx%>/img/no-img.jpg'"/> 
		      		</div>
		   		</div>	
		   	</div>	
		</div>	
